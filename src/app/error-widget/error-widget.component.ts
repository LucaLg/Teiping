...
@Component({
  ...
  template: `
    <div
      class="flex flex-col items-center justify-evenly gap-3 rounded-md p-4 shadow-lg  outline-dotted outline-2  dark:bg-black dark:text-white dark:shadow-sm  dark:shadow-white  dark:outline-white"
    >
